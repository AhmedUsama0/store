...
if(isset($_POST['delete'])){
    ...
    Product::$product_id = $_POST['product-id'];

    //delete the product based on its id
    $database->delete(Product::$product_id);

    //redirect the user to view page
    echo "<script>alert('Product is deleted successfully.'); window.location = '/view';</script>";
}
...
<body>
    ...
    <div class='form-container'>
        <form action="/update" method="POST" enctype="multipart/form-data">
            ...
            <input type='hidden' name='id' value='<?php if(isset($_POST['edit'])) {echo $_POST['product-id'];} ?>'>
